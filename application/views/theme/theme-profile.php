                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                <h4>Saeful Mahmud</h4>
                                                <p class="text-muted">saeful.mahmud@gmail.com</p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    ...
                    <!-- User profile text-->
                    <div class="profile-text">Saefull M <span class="caret"></span></div>
                </div>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="">
                            <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Profile <span class="label label-rounded label-success">5</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="index.html" class="">My Profile</a></li>
                            </ul>
                        </li>
                        <li class="nav-devider"></li>
                        <li class="nav-small-cap">HISTORY</li>
                        <li>
                            <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Activity</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="form-basic.html">History Activity</a></li>
                            </ul>
                        </li>
                        <li class="nav-devider"></li>
                    </ul>
            ...
            <div class="sidebar-footer">
                <!-- item-->
                <a href="" class="link" data-toggle="tooltip" title="Change Password"><i class="ti-key"></i></a>
                <!-- item-->
                <a href="" class="link" data-toggle="tooltip" title="History"><i class="mdi mdi-bullseye"></i></a>
                <!-- item-->
                                                ...
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="<?= base_url()?>assets/images/big/img3.jpg" class="img-responsive radius" /></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="<?= base_url()?>assets/images/big/img4.jpg" class="img-responsive radius" /></div>
                                                        </div>
